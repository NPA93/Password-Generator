...
function generatePassword() {
    ...
    if (document.querySelector("#use-upper").checked) allowedCharacters = allowedCharacters.concat(upperCaseLetters);

    if (document.querySelector("#use-lower").checked) allowedCharacters = allowedCharacters.concat(lowerCaseLetters);

    if (document.querySelector("#use-numbers").checked) allowedCharacters = allowedCharacters.concat(numbers);

    if (document.querySelector("#use-special").checked) allowedCharacters = allowedCharacters.concat(specialCharacters);
